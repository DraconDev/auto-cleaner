...
class SettingsPanel {
    ...
    async _saveSettings(settings) {
        ...
        // Save Analyzers
        await config.update("enabledAnalyzers", settings.enabledAnalyzers, vscode.ConfigurationTarget.Global);
        // Save Whitelists
        await config.update("whitelistFiles", settings.whitelistFiles, vscode.ConfigurationTarget.Global);
        await config.update("whitelistFolders", settings.whitelistFolders, vscode.ConfigurationTarget.Global);
        await config.update("whitelistPatterns", settings.whitelistPatterns, vscode.ConfigurationTarget.Global);
        // Save Excludes
        await config.update("excludePatterns", settings.excludePatterns, vscode.ConfigurationTarget.Global);
        // Save General
        await config.update("dryRun", settings.dryRun, vscode.ConfigurationTarget.Global);
        await config.update("autoClean", settings.autoClean, vscode.ConfigurationTarget.Global);
        await config.update("grayAreaHandling", settings.grayAreaHandling, vscode.ConfigurationTarget.Global);
        await config.update("autoCleanImports", settings.autoCleanImports, vscode.ConfigurationTarget.Global);
        await config.update("autoCleanFunctions", settings.autoCleanFunctions, vscode.ConfigurationTarget.Global);
        await config.update("autoCleanVariables", settings.autoCleanVariables, vscode.ConfigurationTarget.Global);
        await config.update("autoCleanEmptyFiles", settings.autoCleanEmptyFiles, vscode.ConfigurationTarget.Global);
        // Save Granular Settings
        await config.update("cleaning.functions", settings.cleaningFunctions, vscode.ConfigurationTarget.Global);
        await config.update("cleaning.variables", settings.cleaningVariables, vscode.ConfigurationTarget.Global);
    }
    _sendSettingsToWebview() {
        this._panel.webview.postMessage({
            ...
            settings: {
                ...
                autoCleanFunctions: this._configManager.shouldAutoCleanFunctions(),
                autoCleanVariables: this._configManager.shouldAutoCleanVariables(),
                autoCleanEmptyFiles: this._configManager.shouldAutoCleanEmptyFiles(),
                grayAreaHandling: this._configManager.getGrayAreaHandling(),
                cleaningFunctions: this._configManager.getFunctionCleaningSettings(),
                cleaningVariables: this._configManager.getVariableCleaningSettings(),
            },
        });
    }
...
SettingsPanel.viewType = "removeUnusedProSettings";
function getNonce() {
    let text = "";
