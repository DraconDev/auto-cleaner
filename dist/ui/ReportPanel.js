...
class ReportPanel {
    constructor(panel, extensionUri, results, analyzers) {
        this._disposables = [];
        this._panel = panel;
    ...
    static createOrShow(extensionUri, results, analyzers) {
        ...
        ReportPanel.currentPanel = new ReportPanel(panel, extensionUri, results, analyzers);
    }
    dispose() {
    ...
    async _cleanSelectedItems(items) {
        try {
